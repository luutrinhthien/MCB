...
export default function Home() {
    ...
    return (
        <div className='w-[98%]'>
            ...
            <div className='mt-24 w-[100%]' style={{ border: "1px solid #ABF20D", borderRadius: "12px" }}>
                <div className=' grid grid-cols-5'>
                    <div className='col-span-3'>
                        <div className='bg-[#1A1615]' style={{ borderTopLeftRadius: "12px", borderBottomLeftRadius: "12px" }}>
                            ...
                            <div hidden={hoveredDiv !== 1} style={{ backgroundColor: "#ABF20D", color: "black", borderTopLeftRadius: "12px" }} className='p-4'>
                                ...
                                <div onClick={() => window.location.href = '/staking'} style={{ backgroundColor: "black", color: "white", borderRadius: "18px", width: "100%" }}
                            ...
                            <div hidden={hoveredDiv !== 2} style={{ backgroundColor: "#ABF20D", color: "black" }} className='p-4 relative'>
                                ...
                                <div style={{ backgroundColor: "black", color: "white", borderRadius: "18px", width: "100%" }}
                    ...
                    {hoveredDiv == 1 && <div className='col-span-2'>
                    ...
                    {hoveredDiv == 2 && <div className='col-span-2'>
                    ...
                    {hoveredDiv == 3 && <div className='col-span-2'>
